...
SEND_INTERVAL = 0.5        
# mxq 모델 경로
NPU_MODEL_PATH = "/home/tuan-public/Desktop/yolo26_seg_NPU_improve/moo7/moo7_runtime/skku_yolo26_epoch1000_seg.mxq"
# 이미지 저장 경로
OUTPUT_PATH = "/home/tuan-public/Desktop/yolo26_seg_NPU_improve/moo7/moo7_runtime/frame_check"
# 주차장 점유 확인 점 위치 json 파일 경로
JSON_PATH_ANGLE_1 = "/home/tuan-public/Desktop/yolo26_seg_NPU_improve/moo7/moo7_runtime/dot/parking_spots_zoneA_seg_dot.json"
JSON_PATH_ANGLE_2 = "/home/tuan-public/Desktop/yolo26_seg_NPU_improve/moo7/moo7_runtime/dot/parking_spots_zoneB_seg_dot.json"
#latency csv 파일 경로
...
def process_frame(camera_id, frame, mode):
    ...
    if r.masks is not None:
        for i in range(len(r.masks)):
            # r.boxes[i, 5]는 클래스 번호 (0: car)
            if int(r.boxes[i, 5]) == 0:
                # 해당 객체의 세그먼트 영역을 255로 채움
